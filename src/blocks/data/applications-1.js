...
<div class="container">
  <div class="row justify-content-center mb-5 pb-3">
    <div class="col-12 col-lg-8 col-xl-7 text-center">
      <h2 class="display-5 fw-bold mb-3">Get our Free Mobile App</h2>
      ...
      <div class="d-flex flex-wrap justify-content-center">
        <a class="me-3 mb-3 mb-sm-0" href="#">
          <img src="../public/bootstrap5-plain-assets/images/buttons/app-store.svg" alt="">
        </a>
        <a href="#">
          <img src="../public/bootstrap5-plain-assets/images/buttons/google-play.svg" alt="">
        </a>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-12 col-lg-4">
      <div class="d-flex mb-5">
        ...
        <div class="ms-3">
          ...
          <p class="lead text-muted">Pellentesque eu quam vitae mi lacinia consequat quis in metus.</p>
        </div>
      </div>
      <div class="d-flex mb-5">
        <span>
    ...
    <div class="d-none d-lg-block col-4">
      <img class="d-block mx-auto mt-lg-4 mt-xl-0 img-fluid" src="../public/bootstrap5-plain-assets/images/devices/phone-full.svg" alt="">
    </div>
    <div class="col-12 col-lg-4">
      <div class="d-flex mb-5">
        <span>
