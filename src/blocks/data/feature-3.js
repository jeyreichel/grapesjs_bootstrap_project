...
<div class="container">
  <div class="row">
    <div class="col-12 col-lg-5">
      <img class="img-fluid mb-5 d-lg-none" src="../public/bootstrap5-plain-assets/images/blue-400-square.png" alt="">
      <h2 class="display-5 mb-4 fw-bold">Lorem Ipsum dolor sit amet</h2>
      ...
      <div class="d-flex mb-3">
        ...
        <div class="ms-3">
          <h5 class="fw-normal">Quick problem-solving contact</h5>
        </div>
      </div>
      <div class="d-flex mb-3">
        <div class="text-muted">
        ...
        <div class="ms-3">
          <h5 class="fw-normal">Making changes simple and easy</h5>
        </div>
      </div>
      <div class="d-flex">
        <div class="text-muted">
        ...
        <div class="ms-3">
          <h5 class="fw-normal">Exchangeable at any time</h5>
        </div>
      </div>
    </div>
    <div class="d-none d-lg-block position-absolute top-0 end-0 h-100" style="width: 50%; background-image: url('../public/bootstrap5-plain-assets/images/blue-400-square.png'); background-repeat: no-repeat; background-size: cover;"></div>
  </div>
</div>
</section>
`;
